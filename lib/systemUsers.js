export const ROLE_CONFIG = {
  ...
  assessor: {
    ...
    paths: ['/', '/company-360', '/grievances', '/actions', '/audits', '/certificates', '/sims/assessment', '/sims/action-plan', '/sims/compliance', '/spatial-monitoring', '/non-spatial-monitoring', '/weekly-report'],
  },
  verifier: {
    label: 'Verifier',
  ...
  viewer: {
    ...
    paths: ['/', '/company-360', '/sims/compliance', '/weekly-report'],
  },
};
