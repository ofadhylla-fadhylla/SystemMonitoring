export const ROLE_CONFIG = {
  ...
  assessor: {
    ...
    paths: ['/', '/competition-demo', '/innovation-cockpit', '/innovation-impact', '/early-warning', '/audit-room', '/company-360', '/grievances', '/actions', '/audits', '/certificates', '/sims/assessment', '/sims/action-plan', '/sims/compliance', '/spatial-monitoring', '/non-spatial-monitoring', '/weekly-report', '/executive-report'],
  },
  verifier: {
    label: 'Verifier',
  ...
  viewer: {
    ...
    paths: ['/', '/competition-demo', '/innovation-cockpit', '/innovation-impact', '/early-warning', '/audit-room', '/company-360', '/sims/compliance', '/weekly-report', '/executive-report'],
  },
};
