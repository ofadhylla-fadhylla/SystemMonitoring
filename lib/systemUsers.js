export const ROLE_CONFIG = {
  ...
  assessor: {
    ...
    paths: ['/', '/innovation-cockpit', '/innovation-impact', '/early-warning', '/company-360', '/grievances', '/actions', '/audits', '/certificates', '/sims/assessment', '/sims/action-plan', '/sims/compliance', '/spatial-monitoring', '/non-spatial-monitoring', '/weekly-report', '/executive-report'],
  },
  verifier: {
    label: 'Verifier',
  ...
  viewer: {
    ...
    paths: ['/', '/innovation-cockpit', '/innovation-impact', '/early-warning', '/company-360', '/sims/compliance', '/weekly-report', '/executive-report'],
  },
};
